...
<body>
 ...
 -->
        ...
        <main>
            ...
            <div class="insight" style="padding-bottom: 10vh;display: flex; flex-direction: column;">
            <div class="sales">
			    <embed src="assets/Notes/DBMS unit 1 notes  twowaits (1).pdf" width="800px" height="300px" />
			    <div class="middle">
			        <p style="text-align: center; align-items: center; font-size: 500;">DBMS LECTURE NOTES</p>
			    </div>
			</div>
            
            <div class="sales">
			    <embed src="assets/Notes/DBMS unit 2 notes  twowaits.pdf" width="800px" height="300px" />
			    <div class="middle">
			        <p style="text-align: center; align-items: center; font-size: 500;">DBMS LECTURE NOTES</p>
			    </div>
			</div>
            ...
            <div class="sales">
			    <embed src="assets/Notes/DBMS unit 3 notes  twowaits.pdf" width="800px" height="300px" />
			    <div class="middle">
			        <p style="text-align: center; align-items: center; font-size: 500;">DBMS LECTURE NOTES</p>
			    </div>
			</div>
            ...
            <div class="sales">
			    <embed src="assets/Notes/DBMS unit 4 notes  twowaits.pdf" width="800px" height="300px" />
			    <div class="middle">
			        <p style="text-align: center; align-items: center; font-size: 500;">DBMS LECTURE NOTES</p>
			    </div>
			</div>
            ...
            <div class="sales">
			    <embed src="assets/Notes/DBMS unit 5 notes  twowaits.pdf" width="800px" height="300px" />
			    <div class="middle">
			        <p style="text-align: center; align-items: center; font-size: 500;">DBMS LECTURE NOTES</p>
			    </div>
			</div>
